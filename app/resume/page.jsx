  ...
  return (
    ...
    >
      <div className="container mx-auto">
        {/* experience */}
        <div className="px-4 flex flex-col gap-[30px] text-center sm:text-left mt-8">
          <h3 className="text-4xl font-bold">{experience.title}</h3>
          <p className=" max-w-[600px] text-white/60 mx-auto sm:mx-0">
        ...
        {/* education */}
        <div className="px-4 flex flex-col gap-[30px] text-center sm:text-left mt-14">
        ...
        <div className="px-4 flex flex-col gap-[30px] mt-14 mb-16">
          ...
          <ul className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4 sm:gap-4">
